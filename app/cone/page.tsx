...
export default function ConeLesson() {
  ...
  const Cone3D = ({ radius: r, height: h, color = '#3b82f6', showLabels = false, isExample = false, opacity = 0.3 }) => {
        ...
        {showLabels && (
          <>
            ...
            <line>
              ...
              <lineBasicMaterial color="#8b5cf6" linewidth={2} dashSize={0.2} gapSize={0.1} />
            </line>
